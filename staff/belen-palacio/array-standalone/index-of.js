function indexOf(array, searchElement, fromIndex = 0) {
  ...
  while (i < array.length && result < 0) {
    // recorremos el array siempre y cuando el valor de i sea menor a array.length
    if (array[i] === searchElement) result = i; // si mi valor de i es igual a searchElement, guardamos la primer coincidencia
...

{
  ...
  const result2 = indexOf(array2, 3, 4);
  const nativeResult2 = array2.indexOf(3, 4);
